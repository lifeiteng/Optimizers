...
def train(total_loss, global_step, optimizer='sgd', lr=0.1):
  ...
  with tf.control_dependencies([loss_averages_op]):
    opt = OptimizerDict[optimizer](lr)
    if optimizer.find('lookahead') >= 0:
      opt = lookahead_optimizer.LookaheadOptimizer(opt, interval_steps=5, alpha=0.5)
